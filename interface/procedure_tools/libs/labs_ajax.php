...
if ($action === 'print_labels') {
    ...
    while ($count > 0) {
        foreach ($specimens as $t) {
            ...
            $pdf->writeCell(0, 3, '[ ] CMP  [ ] CBC', 0, 1, 'C');
            $pdf->writeCell(0, 3, '[ ] Sputum  [ ] HIV', 0, 1, 'C');
            $pdf->writeCell(0, 3, '[ ] T-SPOT  [ ] HEP B', 0, 1, 'C');
            $pdf->writeCell(0, 3, '[ ] QFT  [ ] HbA1c', 0, 1, 'C');
            $pdf->writeCell(0, 3, 'Other:  ', 0, 1, 'C');
