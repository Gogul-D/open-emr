...
if (! $sale_id) {
  ...
  //
    ...
    // PYXIS INTEGRATION: Inventory decrement happens via DFT message processing, not here
    // The QOH will be decremented when process_hl7.php processes the DFT response from Pyxis
